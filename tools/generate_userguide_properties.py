#!/usr/bin/env python3
"""
Generate User Guide Properties Include

Generates the properties.adoc include file for the user guide
"""
...
def generate_userguide_properties(version=None, output_file=None):
    """
    Generate user guide properties AsciiDoc include
    ...
    template = env.get_template('properties.adoc')
...
def main():
    parser = argparse.ArgumentParser(
        description='Generate user guide properties AsciiDoc include from Google Sheets data'
    )
    parser.add_argument(
        '--version',
    ...
    try:
        output_file = generate_userguide_properties(args.version, args.output)
